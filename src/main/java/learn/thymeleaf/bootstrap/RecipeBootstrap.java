package learn.thymeleaf.bootstrap;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.debug("Loading the mojo... "
                + "recipeRepository.saveAll(getRecipes()) "
                + "inside public void onApplicationEvent(ContextRefreshedEvent event)");
    }
...
//   consolidated in entity Recipe:     guacNotes.setRecipe(guacRecipe);
...
//   consolidated in entity Recipe:     tacoNotes.setRecipe(tacosRecipe);
